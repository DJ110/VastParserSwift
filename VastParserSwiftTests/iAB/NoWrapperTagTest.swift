...
class NoWrapperTagTest: XCTestCase {

    // https://github.com/InteractiveAdvertisingBureau/VAST_Samples/blob/master/VAST%204.1%20Samples/No_Wrapper_Tag-test.xml
    var vastxml: String?
    ...
    func testNoWapperTagTest() throws {
