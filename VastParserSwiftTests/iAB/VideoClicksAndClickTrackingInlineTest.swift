//
//  VideoClicksAndClickTrackingInlineTest.swift
...
class VideoClicksAndClickTrackingInlineTest: XCTestCase {

    // https://github.com/InteractiveAdvertisingBureau/VAST_Samples/blob/master/VAST%204.1%20Samples/Video_Clicks_and_click_tracking-Inline-test.xml
    var vastxml: String?
    ...
    func testVideoClicks() throws {
        ...
        XCTAssertEqual(1, vastParser.vast.vastAd?.vastInline?.creatives.creative[0].linear?.videoClicks?.clickTracking.count)
        ...
        XCTAssertEqual("http://myTrackingURL/clickTracking", vastParser.vast.vastAd?.vastInline?.creatives.creative[0].linear?.videoClicks?.clickTracking[0].uri)
    }
}
